...
function FloatingPhoneViewer({ isVisible, onClose }) {
    ...
    >
      <div className="phone-frame" onClick={(e) => e.stopPropagation()}>
        <div class="phone-screen">
          ...
          <div class="phone-button-menu phone-button-menu1"></div>
          <svg
            height="24"
            width="24"
          ...
          >
            <div class="phone-option">
              ...
              <div class="phone-japanese">にぎり</div>
              <div class="phone-roman">Nigiri</div>
            </div>
            <div class="phone-option">
              <svg
                class="phone-food"
              ...
              <div class="phone-japanese">細巻き</div>
              <div class="phone-roman">Hosomaki</div>
            </div>
            <div class="phone-option">
              <svg
                class="food"
              ...
              <div class="phone-japanese">天ぷら</div>
              <div class="phone-roman">Tempura</div>
            </div>
            <div class="phone-option">
              <svg
                class="phone-food"
              ...
              <div class="phone-japanese">そば</div>
              <div class="phone-roman">Soba</div>
            </div>
            <div class="phone-option">
              <svg
                class="phone-food"
              ...
              <div class="phone-japanese">団子</div>
              <div class="phone-roman">Dango</div>
            </div>
            <div class="phone-option">
              <svg
                class="phone-food"
              ...
              <div class="phone-japanese">餃子</div>
              <div class="phone-roman">Gyoza</div>
            </div>
          </div>
        </div>
      </div>
...
export default FloatingPhoneViewer;
